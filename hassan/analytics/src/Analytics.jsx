...
const Analytics = () => {
  return (
    ...
    >
      <div class="px-6 mb-8">
        <h1
          class="font-headline-md text-headline-md font-bold text-white tracking-tight"
        >
          PSMS Uganda
        </h1>
        <p
          class="text-on-surface-variant font-label-md text-label-md opacity-70"
        >
          Super Admin Portal
        </p>
      </div>
      <nav class="flex-1 overflow-y-auto scrollbar-hide px-3 space-y-1">
        ...
        >
          <span class="material-symbols-outlined" data-icon="how_to_reg"
            >how_to_reg</span
          >
          <span class="font-body-md text-body-md">Admissions</span>
        </a>
        <a
          class="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:text-white hover:bg-white/5 transition-colors rounded-r"
          href="#"
        >
          <span class="material-symbols-outlined" data-icon="school"
            >school</span
          >
        ...
        <a
          ...
          href="#"
        >
          <span class="material-symbols-outlined" data-icon="supervisor_account"
            >supervisor_account</span
          >
          <span class="font-body-md text-body-md">Teachers</span>
        </a>
        <a
          class="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:text-white hover:bg-white/5 transition-colors rounded-r"
          href="#"
        >
          ...
          >
          <span class="font-body-md text-body-md">Parents</span>
        </a>
        <a
          class="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:text-white hover:bg-white/5 transition-colors rounded-r"
          href="#"
        ...
        >
          <span class="material-symbols-outlined" data-icon="payments"
            >payments</span
          >
          <span class="font-body-md text-body-md">School Fees</span>
        </a>
        <a
          class="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:text-white hover:bg-white/5 transition-colors rounded-r"
          href="#"
        ...
        <a
          ...
          href="#"
        >
          <span class="material-symbols-outlined" data-icon="local_library"
            >local_library</span
          >
          <span class="font-body-md text-body-md">Library</span>
        </a>
      </nav>
      <div class="mt-auto px-6 pt-6 border-t border-white/10 space-y-2">
        <button
          class="w-full bg-primary-container text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-transform active:scale-95 shadow-lg shadow-primary-container/20"
        >
        ...
        <div class="pt-4 space-y-1">
          <a
            class="flex items-center gap-3 px-4 py-2 text-on-surface-variant hover:text-white transition-colors"
            href="#"
          >
    ...
    >
      <div class="flex items-center gap-4 flex-1">
        <div class="relative w-full max-w-md">
          ...
          >
          <input
            class="w-full pl-10 pr-4 py-2 bg-surface-container-low border-none rounded-full text-body-md focus:ring-2 focus:ring-primary-container"
      ...
      <div class="flex items-center gap-6">
        <div class="flex items-center gap-4">
          ...
          >
            ...
            >
            <span
              class="absolute top-2 right-2 w-2 h-2 bg-error rounded-full border-2 border-white"
            ></span>
          </div>
          <div
            class="p-2 rounded-full hover:bg-surface-container-low cursor-pointer transition-colors"
          >
            <span
              class="material-symbols-outlined text-on-surface-variant"
      ...
      <div class="p-margin-desktop space-y-gutter">
        ...
        <div class="flex justify-between items-end">
          ...
          <div class="flex gap-3">
            <button
              class="px-4 py-2 bg-white border border-outline-variant text-on-surface font-bold rounded-lg flex items-center gap-2 hover:bg-surface-container-low transition-colors"
            >
            ...
            <button
              class="px-4 py-2 bg-primary-container text-white font-bold rounded-lg flex items-center gap-2 hover:bg-primary transition-all active:scale-95"
            >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-gutter">
          ...
          >
            <div>
              <p
                class="text-on-surface-variant font-label-md text-label-md uppercase tracking-widest mb-1"
              >
                Total Students
              </p>
          ...
          >
            ...
            <div
              class="p-3 bg-tertiary-container/10 rounded-xl text-tertiary-container"
            >
              <span
                class="material-symbols-outlined text-[32px]"
          ...
          >
            <div>
              ...
              <div class="flex items-center gap-1 mt-2 text-primary">
                <div
                  class="w-16 h-1 bg-surface-container-high rounded-full overflow-hidden"
                >
                  <div class="w-[75%] h-full bg-primary-container"></div>
                </div>
                <span class="font-label-md text-label-md">75% of target</span>
              </div>
            </div>
            <div
              class="p-3 bg-secondary-container/10 rounded-xl text-secondary-container"
            >
              <span
                class="material-symbols-outlined text-[32px]"
                data-icon="payments"
          ...
          >
            ...
            <div
              class="p-3 bg-on-tertiary-fixed-variant/10 rounded-xl text-on-tertiary-fixed-variant"
            >
              <span
                class="material-symbols-outlined text-[32px]"
                data-icon="menu_book"
        ...
        <div class="bento-grid">
          ...
          >
            <div class="flex justify-between items-center mb-6">
              ...
              <select
                class="bg-surface-container-low border-none text-label-md rounded-lg focus:ring-primary-container"
              >
            ...
            >
              <div
                class="absolute inset-0 flex items-end justify-between px-6 pb-4"
              >
                <div
                  class="w-[12%] h-[40%] bg-primary-container/20 rounded-t-lg"
                ></div>
                <div
                  class="w-[12%] h-[60%] bg-primary-container/30 rounded-t-lg"
                ></div>
                <div
                  class="w-[12%] h-[55%] bg-primary-container/40 rounded-t-lg"
                ></div>
                <div
                  class="w-[12%] h-[80%] bg-primary-container/50 rounded-t-lg"
                ></div>
                <div
                  class="w-[12%] h-[70%] bg-primary-container/60 rounded-t-lg"
                ></div>
                <div
                  class="w-[12%] h-[90%] bg-primary-container rounded-t-lg shadow-lg"
                ></div>
              </div>
              <p class="text-primary font-bold z-10 flex items-center gap-2">
          ...
          <div class="col-span-12 lg:col-span-4 glass-card p-6 flex flex-col">
            ...
            <p class="text-on-surface-variant font-label-md text-label-md mb-8">
              Current Term Progress
            </p>
            <div class="flex-1 flex flex-col items-center justify-center gap-6">
              <div
                class="relative w-48 h-48 rounded-full border-[16px] border-surface-container flex items-center justify-center"
              >
                <div
                  class="absolute inset-[-16px] w-48 h-48 rounded-full border-[16px] border-primary-container border-t-transparent border-r-transparent rotate-45"
                ></div>
                <div class="text-center">
                  <p
                    class="font-headline-lg text-headline-lg text-on-surface leading-none"
                  >
                    75%
                  </p>
                  <p
              ...
              <div class="w-full space-y-3">
                <div class="flex justify-between items-center text-body-md">
                  ...
                  <span class="font-bold">1,837</span>
                </div>
                <div class="flex justify-between items-center text-body-md">
                  <div class="flex items-center gap-2">
                    <div
                      class="w-3 h-3 rounded-full bg-tertiary-container"
                    ></div>
                    <span>Partial</span>
                  </div>
          ...
          <div class="col-span-12 lg:col-span-7 glass-card p-6">
            <div class="flex justify-between items-center mb-6">
              ...
              <button
                class="text-primary font-bold font-label-md text-label-md hover:underline"
              >
                View All
              </button>
            </div>
            <div class="space-y-6">
              ...
              <div class="flex gap-4 group cursor-pointer">
                ...
                <div class="flex-1 border-b border-outline-variant pb-4">
                  <div class="flex justify-between items-start">
                    <p class="font-bold text-on-surface">
                      New Student Admission
                    </p>
                    <span
                      class="text-on-surface-variant font-label-md text-label-md"
                      >10 mins ago</span
                    >
                  </div>
              ...
              <div class="flex gap-4 group cursor-pointer">
                ...
                <div class="flex-1 border-b border-outline-variant pb-4">
                  <div class="flex justify-between items-start">
                    <p class="font-bold text-on-surface">Recent Fee Payment</p>
                    <span
                      class="text-on-surface-variant font-label-md text-label-md"
                      >25 mins ago</span
                    >
          ...
          <div class="col-span-12 lg:col-span-5 glass-card p-6">
            <div class="flex justify-between items-center mb-6">
              ...
              <button
                class="p-2 rounded-lg bg-surface-container-low hover:bg-surface-container transition-colors"
              >
                <span
                  class="material-symbols-outlined text-on-surface-variant"
            ...
            <div class="space-y-4">
              <div
                class="p-4 rounded-xl bg-primary/5 border border-primary/10 flex gap-4"
              >
                <div
                  class="flex flex-col items-center justify-center px-4 py-2 bg-white rounded-lg shadow-sm border border-outline-variant min-w-[70px]"
                >
                  <span
                    class="text-[10px] uppercase font-bold text-on-surface-variant"
                    >May</span
                  >
                ...
                <div class="flex-1">
                  ...
                  <div class="flex -space-x-2 mt-3">
                    <div
                      class="w-6 h-6 rounded-full border-2 border-white bg-surface-dim"
                    ></div>
                    <div
                      class="w-6 h-6 rounded-full border-2 border-white bg-surface-container-high"
                    ></div>
                    <div
                      class="w-6 h-6 rounded-full border-2 border-white bg-primary-fixed-dim"
                    ></div>
                    <div
                      class="w-6 h-6 rounded-full border-2 border-white bg-surface-container-lowest flex items-center justify-center text-[10px] font-bold text-on-surface-variant"
                    >
                      +12
                    </div>
                  </div>
              ...
              <div class="p-4 rounded-xl bg-surface-container-low flex gap-4">
                <div
                  class="flex flex-col items-center justify-center px-4 py-2 bg-white rounded-lg shadow-sm border border-outline-variant min-w-[70px]"
                >
                  <span
                ...
                <div class="flex-1">
                  <p class="font-bold text-on-surface">Staff Meeting</p>
                  <p class="text-body-md text-on-surface-variant">
                    03:30 PM - Main Hall
                  </p>
                  <p
                    class="mt-2 text-primary font-label-md text-label-md flex items-center gap-1"
                  >
                    <span
              ...
              <button
                class="w-full py-3 border-2 border-dashed border-outline-variant rounded-xl text-on-surface-variant font-bold hover:bg-surface-container-low transition-all"
              >
                + Add New Event
              </button>
            </div>
        ...
        <div class="glass-card overflow-hidden">
          ...
          >
            ...
            <span
              class="px-3 py-1 bg-on-tertiary-fixed-variant/10 text-on-tertiary-fixed-variant text-[12px] font-bold rounded-full"
              >All Systems Normal</span
            >
          </div>
          <div
            class="grid grid-cols-1 md:grid-cols-3 divide-x divide-outline-variant"
          >
            <div class="p-6 space-y-3">
              ...
              <p class="text-headline-md font-bold text-on-surface">12 / 14</p>
              <p class="text-body-md text-on-surface-variant">
            ...
            <div class="p-6 space-y-3">
              <div class="flex items-center gap-3 text-on-surface-variant">
                <span class="material-symbols-outlined" data-icon="hotel"
                  >hotel</span
                >
                <span class="font-bold">Hostel Capacity</span>
              </div>
              <p class="text-headline-md font-bold text-on-surface">88%</p>
              <p class="text-body-md text-on-surface-variant">
                42 spaces available.
              </p>
            </div>
            <div class="p-6 space-y-3">
              <div class="flex items-center gap-3 text-on-surface-variant">
                <span
                  ...
                  >local_library</span
                >
                <span class="font-bold">Library Activity</span>
              </div>
